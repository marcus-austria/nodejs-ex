...
Pointing `oc new-app` at source code kicks off a chain of events, for our example run:
        ...
        $ oc new-app https://github.com/marcus-austria/nodejs-ex -l name=myapp
...
We can also [create new apps using OpenShift template files](https://docs.openshift.com/enterprise/3.0/dev_guide/new_app.html#specifying-a-template). Clone the demo app source code from [GitHub repo](https://github.com/marcus-austria/nodejs-ex) (fork if you like).

        $ git clone https://github.com/marcus-austria/nodejs-ex
...
Which should return something like:
        ...
        svc/nodejs-ex - 172.30.108.183:8080
          dc/nodejs-ex deploys istag/nodejs-ex:latest <-
            bc/nodejs-ex builds https://github.com/marcus-austria/nodejs-ex with openshift/nodejs:0.10
